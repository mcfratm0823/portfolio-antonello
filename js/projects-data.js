...
export const PROJECTS_DATA = {
    ...
    'progetto-due': {
        ...
        content: {
            concept: {
                label: '(VISION)',
                text: 'UNA TRASFORMAZIONE RADICALE CHE RIDEFINISCE I CODICI VISIVI DEL BRAND. IL PROGETTO HA ABBRACCIATO UNA FILOSOFIA MINIMALISTA E CONTEMPORANEA, CREANDO UN SISTEMA DI COMUNICAZIONE CHE PARLA DIRETTAMENTE AL TARGET MODERNO CON CHIAREZZA E IMPATTO.'
            },
            approach: {
                label: '(STRATEGIA)',
                text: 'ATTRAVERSO UNA RICERCA APPROFONDITA E WORKSHOP COLLABORATIVI, ABBIAMO SVILUPPATO UNA STRATEGIA DI BRAND CHE COMBINA HERITAGE E INNOVAZIONE. OGNI ELEMENTO GRAFICO È STATO PROGETTATO PER MASSIMIZZARE LA RICONOSCIBILITÀ E L\'ENGAGEMENT CROSS-PLATFORM.'
            }
        }
    },
    ...
    'progetto-tre': {
        ...
        content: {
            concept: {
                label: '(UX VISION)',
                text: 'UN\'ESPERIENZA DIGITALE CHE RIDEFINISCE GLI STANDARD DEL SETTORE. ABBIAMO PROGETTATO UN\'INTERFACCIA INTUITIVA E PERFORMANTE CHE METTE L\'UTENTE AL CENTRO, OTTIMIZZANDO OGNI INTERAZIONE PER MASSIMIZZARE CONVERSIONI E SODDISFAZIONE.'
            },
            approach: {
                label: '(TECH APPROACH)',
                text: 'UTILIZZANDO TECNOLOGIE ALL\'AVANGUARDIA E METODOLOGIE AGILI, ABBIAMO SVILUPPATO UNA PIATTAFORMA SCALABILE E FLESSIBILE. L\'ARCHITETTURA MODULARE GARANTISCE PERFORMANCE ECCELLENTI E FACILITÀ DI MANUTENZIONE NEL TEMPO.'
            }
        }
    },
